...
var currentPositionX = function currentPositionX() {
  if (__containerElement && __containerElement !== document && __containerElement !== document.body) {
...
var animateScroll = function animateScroll(easing, timestamp) {
...
var startAnimateScroll = function startAnimateScroll(x, y, options, to, target) {
